...
var BlogCreateComponent = /** @class */ (function () {
    function BlogCreateComponent(toastr, httpservice, _route, router) {
        this.toastr = toastr;
    ...
    BlogCreateComponent.prototype.createBlog = function () {
        ...
        this.httpservice.create(blogData).subscribe(function (data) {
            console.log('blog created');
            console.log(data);
            _this.toastr.success('blog posted', 'Success');
            setTimeout(function () {
                _this.router.navigate(['/view', data.data.blogId]);
            }, 3000);
        }, function (error) {
...
var BlogEditComponent = /** @class */ (function () {
    ...
    BlogEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        var myBlogId = this._route.snapshot.paramMap.get('id');
        console.log(myBlogId);
        this.currentBlog = this.blogHttpService.getsingle(myBlogId).subscribe(function (data) {
            console.log(data);
    ...
    BlogEditComponent.prototype.editBlog = function () {
        var _this = this;
        this.blogHttpService.edit(this.currentBlog.blogId, this.currentBlog).subscribe(function (data) {
            console.log('blog created');
            console.log(data);
            _this.toastr.success('blog posted', 'Success');
            setTimeout(function () {
                _this.router.navigate(['/view', _this.currentBlog.blogId]);
            }, 2000);
        }, function (error) {
            console.log("error in blog");
            console.log(error.errorMessage);
...
var BlogViewComponent = /** @class */ (function () {
    function BlogViewComponent(location, _route, router, httpService) {
    ...
    BlogViewComponent.prototype.ngOnInit = function () {
        ...
        var myBlogId = this._route.snapshot.paramMap.get('id');
        console.log(myBlogId);
        this.httpService.getsingle(myBlogId).subscribe(function (data) {
            console.log(data);
            _this.currentBlog = data['data'];
        }, function (error) {
            console.log('error');
    ...
    BlogViewComponent.prototype.deleteblog = function () {
        var _this = this;
        this.httpService.delete(this.currentBlog.blogId).subscribe(function (data) {
            console.log(data);
            setTimeout(function () {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.allBlogs = this.httpservice.getall().subscribe(function (data) {
            console.log(data);
...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.getall = function () {
        var all = this._http.get(this.baseUrl + ("/all" + this.token));
        console.log(all);
        return all;
    };
    HttpServiceService.prototype.getsingle = function (currentBlogId) {
        var one = this._http.get(this.baseUrl + '/view/' + ("" + currentBlogId + this.token));
        return one;
    };
    HttpServiceService.prototype.create = function (blogdata) {
        var a = this._http.post(this.baseUrl + '/create/' + ("" + this.token), blogdata);
        return a;
    };
    HttpServiceService.prototype.delete = function (blogId) {
        var a = this._http.post(this.baseUrl + '/' + ("" + blogId) + '/delete' + ("" + this.token), blogId);
        return a;
    };
    HttpServiceService.prototype.edit = function (blogId, blogdata) {
        var b = (this.baseUrl + '/' + ("" + blogId) + '/edit' + ("" + this.token));
        console.log(b);
        var a = this._http.put(this.baseUrl + '/' + ("" + blogId) + '/edit' + ("" + this.token), blogdata);
        return a;
    };
